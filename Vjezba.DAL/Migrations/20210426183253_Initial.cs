    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_threeDCategoryes", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_threeD_threeDCategoryes_CategoryID",
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "ID", "Address", "CityID", "CreatedBy", "DateOfBirth", "Email", "FirstName", "Gender", "LastName", "PhoneNumber", "UpdatedBy", "WorkingExperience" },
                values: new object[] { 1, null, 1, null, null, "mmarkic@index.hr", "Marko", " ", "Markic", null, null, null });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "ID", "Address", "CityID", "CreatedBy", "DateOfBirth", "Email", "FirstName", "Gender", "LastName", "PhoneNumber", "UpdatedBy", "WorkingExperience" },
                values: new object[] { 2, null, 2, null, null, "aanic@yahoo.com", "Ana", " ", "Anic", null, null, null });
